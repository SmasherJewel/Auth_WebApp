...
public class UserServiceImpl implements UserService {
    ...
    public UserDto createUser(UserDto userDto) {
        ...
        Role role = roleRepository.findByName(AppConstants.ROLE_PREFIX + AppConstants.USER_ROLE)
                .orElseGet(() -> roleRepository.save(
                        Role.builder().name(AppConstants.ROLE_PREFIX + AppConstants.USER_ROLE).build()
                ));
